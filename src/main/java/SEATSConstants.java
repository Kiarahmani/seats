...
public abstract class SEATSConstants {
	...
	/**
	 * Number of seats available per flight If you change this then you must also
	 * change FindOpenSeats
	 */
	public static final int FLIGHTS_NUM_SEATS = 150;

	/**
	 * How many First Class seats are on a given flight These reservations are more
	 * expensive
	 */
	...
	/**
	 * The maximum number of days that we allow a customer to wait before needing a
	 * reservation on a return to their original departure airport
	 */
	...
	public static final String TABLES_DATAFILES[] = { SEATSConstants.TABLENAME_COUNTRY,
			SEATSConstants.TABLENAME_AIRPORT, SEATSConstants.TABLENAME_AIRLINE, };

	/**
	 * Tables generated from random data IMPORTANT: FLIGHT must come before
	 * FREQUENT_FLYER
	 */
	public static final String TABLES_SCALING[] = { SEATSConstants.TABLENAME_CUSTOMER,
			SEATSConstants.TABLENAME_AIRPORT_DISTANCE, SEATSConstants.TABLENAME_FLIGHT,
			SEATSConstants.TABLENAME_FREQUENT_FLYER, SEATSConstants.TABLENAME_RESERVATION, };

	/** Configuration Tables */
	public static final String TABLES_CONFIG[] = { SEATSConstants.TABLENAME_CONFIG_PROFILE,
			SEATSConstants.TABLENAME_CONFIG_HISTOGRAMS, };

	/** Histograms generated from data files */
	public static final String HISTOGRAM_DATA_FILES[] = { SEATSConstants.HISTOGRAM_FLIGHTS_PER_AIRPORT,
	 ...
	 * data tables instead of the id. Thus, we need to keep a table of how to map
	 * these codes to the ids when loading.
	 */
	public static final String CODE_TO_ID_COLUMNS[][] = { { TABLENAME_COUNTRY, "CO_CODE_3", "CO_ID" },
			{ TABLENAME_AIRPORT, "AP_CODE", "AP_ID" }, { TABLENAME_AIRLINE, "AL_IATA_CODE", "AL_ID" }, };
}
