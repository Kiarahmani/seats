...
LOAD DATA LOCAL INFILE 'load_customer.txt' 
 INTO TABLE CUSTOMER FIELDS TERMINATED BY ',';

LOAD DATA LOCAL INFILE 'load_airport.txt' 
 INTO TABLE AIRPORT FIELDS TERMINATED BY ',';

LOAD DATA LOCAL INFILE 'load_country.txt' 
 INTO TABLE COUNTRY FIELDS TERMINATED BY ',';

LOAD DATA LOCAL INFILE 'load_airline.txt' 
 INTO TABLE AIRLINE FIELDS TERMINATED BY ',';

LOAD DATA LOCAL INFILE 'load_ff.txt' 
 INTO TABLE FREQUENT_FLYER FIELDS TERMINATED BY ',';

LOAD DATA LOCAL INFILE 'load_flight.txt' 
